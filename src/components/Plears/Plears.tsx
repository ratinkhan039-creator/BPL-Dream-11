...
export default function Plears({ plearsData, coin, setCoin }: plearDataProps) {
    ...
    return (
        <>
            <div className="container mx-auto px-5 grid gap-6 my-9 mb-65">
                <div className="flex items-center justify-between">
                    ...
                    <div>
                        <button
                            ...
                            className={`btn rounded-r-none rounded-l-xl ${buttonType === "available" ? "bg-linear-to-r from-pink-400 via-orange-300  to-yellow-400" : ""}`}
                        >
                            Available
                        </button>
                        <button
                            onClick={() => setButtonType("selected")}
                            className={`btn rounded-r-xl rounded-l-none ${buttonType === "selected" ? "bg-linear-to-r from-pink-400 via-orange-300  to-yellow-400" : ""}`}
                        >
